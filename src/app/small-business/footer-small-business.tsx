...
export function FooterSmallBusiness() {
  return (
    <footer className="snap-start h-screen w-full bg-gradient-to-b from-slate-900 via-green-950/50 to-slate-900 flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left max-w-4xl mx-auto">
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link href="/enterprise" className="block text-gray-400 hover:text-blue-300 transition-colors">
                Enterprise
              </Link>
              <Link href="/small-business" className="block text-green-300 hover:text-green-200 transition-colors font-medium">
                Small Business
              </Link>
