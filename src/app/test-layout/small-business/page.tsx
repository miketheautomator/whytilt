...
import { LifestyleSmallBusiness } from '../lifestyle-small-business';
import { UseCasesSmallBusiness } from '../use-cases-small-business';
  ...
  return (
    <div className="h-screen w-screen relative">
      ...
      <div className="fixed inset-0 z-0" style={{ opacity: 0.6 }}>
        <Aurora
          colorStops={["#059669", "#0D9488", "#0F172A"]}
          blend={0.5}
          amplitude={1.0}
          speed={0.5}
        />
